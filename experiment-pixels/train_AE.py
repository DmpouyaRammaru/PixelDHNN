...
from data_diss_simulation import get_dataset
...
def train(args):
  ...
  train_dist, ae_dist, cc_dist = pixelhnn_loss(x, next_x, model, return_scalar=False)
  test_dist = pixelhnn_loss(test_x, test_next_x, model, return_scalar=False)[0]
