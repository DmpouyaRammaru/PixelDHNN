...
def sample_gym(seed=0, timesteps=103, trials=200, side=28, min_angle=0., max_angle=np.pi/6, 
    ...
    path = "/Users/ranmaru/Documents/hnn-d/hamiltonian-nn-master/experiment-pixels/d-1120_6_01-free.pkl"
...
def make_gym_dataset(test_split=0.2, **kwargs):
    ...
    print(f"coords:{type(coords)}") # class list
    print(f"coords:{len(coords)}") # number of trials
